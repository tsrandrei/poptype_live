defmodule PoptypeLive.Subscribers do
  @moduledoc """
  ...
  def subscribers_in_last_7_days do
    # query = from u in "users",
    #       where: u.age > 18,
    #       select: u.name
    # days_7_ago = Timex.shift(Timex.today, days: -7)
    # Repo.all()
    # |> select()
    query = from s in Subscriber, select: s, where: s.inserted_at >= date_add(^NaiveDateTime.utc_now(), -7, "day")
